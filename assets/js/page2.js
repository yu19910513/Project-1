      ...
      for (let l = 0; l < eT.length; l++) {
        for (let p = 0; p < pST.length; p++) {
          if (localStorage.getItem("stateVisited") === "Arizona") {
            $(".currenttime").text(
              d.toLocaleString("en-US", { timeZone: cityArray[2] })
            );
          }
          if (localStorage.getItem("stateVisited") === cT[j]) {
            $(".currenttime").text(
              d.toLocaleString("en-US", { timeZone: cityArray[4] })
            );
          }
          if (localStorage.getItem("stateVisited") === mT[k]) {
            $(".currenttime").text(
              d.toLocaleString("en-US", { timeZone: cityArray[3] })
            );
          }
          if (localStorage.getItem("stateVisited") === eT[l]) {
            $(".currenttime").text(
              d.toLocaleString("en-US", { timeZone: cityArray[0] })
            );
          }
          if (localStorage.getItem("stateVisited") === pST[p]) {
            $(".currenttime").text(
              d.toLocaleString("en-US", { timeZone: cityArray[1] })
            );
          }
          if (localStorage.getItem("stateVisited") === "Hawaii") {
            $(".currenttime").text(
              d.toLocaleString("en-US", { timeZone: cityArray[6] })
            );
          }
          if (localStorage.getItem("stateVisited") === "Alaska") {
            $(".currenttime").text(
              d.toLocaleString("en-US", { timeZone: cityArray[5] })
            );
          }
        }
      }
